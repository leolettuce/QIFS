...
def Diff_1_2_y_MPO(n, dx):
    ...
    central_node[0, 2, 1, 2] = 1    # 00 -> 01 carry for subtraction (2)
    central_node[1, 0, 0, 2] = 1    # 01 -> 00 no carry (0)
    central_node[2, 2, 3, 2] = 1    # 10 -> 11 carry for subtraction (2)
...
def Diff_1_2_x_MPO(n, dx):
    ...
    # 2 from right: subtract 1
    central_node[0, 2, 2, 2] = 1    # 00 -> 10 carry for subtraction (2)
    central_node[1, 2, 3, 2] = 1    # 01 -> 11 carry for subtraction (2)
...
def Diff_1_8_y_MPO(n, dx):
    ...
    # 2 from right: subtract 1
    sec_last_node[0, 2, 1, 2] = 1    # 00 -> 01 carry for subtraction (2)
    sec_last_node[1, 0, 0, 2] = 1    # 01 -> 00 no carry (0)
    sec_last_node[2, 2, 3, 2] = 1    # 10 -> 11 carry for subtraction (2)
    ...
    sec_last_node[0, 2, 0, 4] =  1   # 00 -> 00 carry for subtraction (2)
    sec_last_node[1, 2, 1, 4] =  1   # 01 -> 01 carry for subtraction (2)
    sec_last_node[2, 2, 2, 4] =  1   # 10 -> 10 carry for subtraction (2)
    sec_last_node[3, 2, 3, 4] =  1   # 11 -> 11 carry for subtraction (2)
    # last node
    ...
    # 2 from right: subtract 1
    last_node[0, 2, 1, 2] = 1    # 00 -> 01 carry for subtraction (2)
    last_node[1, 0, 0, 2] = 1    # 01 -> 00 no carry (0)
    last_node[2, 2, 3, 2] = 1    # 10 -> 11 carry for subtraction (2)
    ...
    last_node[0, 2, 0, 3] = -1   # 00 -> 00 carry for subtraction (2)
    last_node[1, 2, 1, 3] = -1   # 01 -> 01 carry for subtraction (2)
    last_node[2, 2, 2, 3] = -1   # 10 -> 10 carry for subtraction (2)
    last_node[3, 2, 3, 3] = -1   # 11 -> 11 carry for subtraction (2)
    ...
    last_node[0, 4, 1, 4] = -1   # 00 -> 01 carry for subtraction one further (4)
    last_node[1, 2, 0, 4] = -1   # 01 -> 00 carry for subtraction (2)
    last_node[2, 4, 3, 4] = -1   # 10 -> 11 carry for subtraction one further (4)
    last_node[3, 2, 2, 4] = -1   # 11 -> 10 carry for subtraction (2)
    ...
    last_node[0, 4, 0, 5] = -1   # 00 -> 00 carry for subtraction one further (4)
    last_node[1, 4, 1, 5] = -1   # 01 -> 01 carry for subtraction one further (4)
    last_node[2, 4, 2, 5] = -1   # 10 -> 10 carry for subtraction one further (4)
    last_node[3, 4, 3, 5] = -1   # 11 -> 11 carry for subtraction one further (4)
    # right terminator
...
def Diff_1_8_x_MPO(n, dx):
    ...
    # 2 from right: subtract 1
    sec_last_node[0, 2, 2, 2] = 1    # 00 -> 10 carry for subtraction (2)
    sec_last_node[1, 2, 3, 2] = 1    # 01 -> 11 carry for subtraction (2)
    ...
    # 2 from right: subtract 1
    last_node[0, 2, 2, 2] = 1    # 00 -> 10 carry for subtraction (2)
    last_node[1, 2, 3, 2] = 1    # 01 -> 11 carry for subtraction (2)
    ...
    last_node[0, 4, 2, 4] = -1   # 00 -> 10 carry for subtraction one further (4)
    last_node[1, 4, 3, 4] = -1   # 01 -> 11 carry for subtraction one further (4)
    last_node[2, 2, 0, 4] = -1   # 10 -> 00 carry for subtraction (2)
    last_node[3, 2, 1, 4] = -1   # 11 -> 01 carry for subtraction (2)
    # 5 from right: add and subtract 4
    last_node[0, 3, 0, 5] = 1    # 00 -> 00 carry for addition one further (3)
    last_node[1, 3, 1, 5] = 1    # 01 -> 01 carry for addition one further (3)
    last_node[2, 3, 2, 5] = 1    # 10 -> 10 carry for addition one further (3)
